package com.mikelalvarezgo.quinielator.shared.infrastructure.logger
...
final case class ScalaLoggingLogger(name: String) extends Logger {
  ...
  def info(msg: String, params: Map[String, Any]): Unit    = logger.info(toMessage(msg, params))
  def info(msg: String, cause: Throwable): Unit            = logger.info(msg, cause)
  def info(msg: String): Unit                              = logger.info(msg)
  def warning(msg: String, params: Map[String, Any]): Unit = logger.warn(toMessage(msg, params))
  def warning(msg: String, cause: Throwable): Unit         = logger.warn(msg, cause)
  def warning(msg: String): Unit                           = logger.warn(msg)
  def error(msg: String, params: Map[String, Any]): Unit   = logger.error(toMessage(msg, params))
  def error(msg: String, cause: Throwable): Unit           = logger.error(msg, cause)
  def error(msg: String): Unit                             = logger.error(msg)
  def debug(msg: String, params: Map[String, Any]): Unit   = logger.debug(toMessage(msg, params))
